...
export function SectionHeader({
  ...
  return (
    <div className={cn("mb-8 sm:mb-10 md:mb-14", alignClass)}>
      {subtitle && (
      ...
      <h2 className="mt-3 sm:mt-4 text-2xl sm:text-3xl md:text-4xl font-serif font-bold text-foreground leading-tight">
        {title}
      </h2>
